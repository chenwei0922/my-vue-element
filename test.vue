...
const queryEvent = () => {
	console.log('you click query btn. the value of query field value =', query.versionName)
}
	...
	<div class="app-container">
		...
		<div class="qy-card version">
			...
			<div class="top-view">
				...
				<div class="btns">
					<qy-button type="info" @click="queryEvent()">{{ $tm('page.queryBtn') }}</qy-button>
					<qy-button type="primary" @click="addEvent()">{{ $tm('page.addBtn') }}</qy-button>
				</div>
			</div>
			<div class="content-view">
				<qy-table :data="state.data">
					<qy-table-column :label="$tm('appDetail.version.nameLabel')" prop="name" />
					<qy-table-column :label="$tm('appDetail.version.buildLabel')" prop="buildName" />
					<qy-table-column :label="$tm('appDetail.version.assetLabel')" prop="materialName" />
					...
					<qy-table-column :label="$tm('appDetail.version.reviewTimeLabel')" prop="reviewTime" />
					<qy-table-column :label="$tm('appDetail.version.publishTimeLabel')" prop="publishTime" />
					<qy-table-column :label="$tm('page.actionLabel')">
						<template #default="{ row }">
							<qy-button type="primary" text @click="detailEvent(row)">{{ $tm('page.detailBtn') }}</qy-button>
							<qy-button type="primary" text @click="editEvent(row)">{{ $tm('page.editBtn') }}</qy-button>
						</template>
					</qy-table-column>
				</qy-table>
			</div>
